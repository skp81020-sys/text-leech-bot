    ...
    try:
        for i in range(count - 1, len(links)):
            ...
            try:
                ...
                # ClassPlus Handling with Token Rotation
                elif 'videos.classplusapp' in url or 'classplusapp' in url:
                ...
                # Utkarsh App Handling
                elif 'utkarshapp.com' in url:
                    # Extract ID from URL
                    if '/master.mpd' in url:
                        id = url.split("/")[-2]
                        url = f"https://apps-s3-prod.utkarshapp.com/{id}/master.m3u8"
                    else:
                        url = url.replace('utkarshapp.mpdr', 'utkarshapp')
                ...
                # PDF Handling
                    ...
                    try:
                        ...
                        download_cmd = f"{cmd} -R 25 --fragment-retries 25 --hls-prefer-ffmpeg --no-keep-video --remux-video mkv --no-warning"
        ...
        await m.reply_text(f"𝐌𝐚𝐢𝐧 𝐄𝐫𝐫𝐨𝐫: {e}")
